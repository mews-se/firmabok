---
name: year-end
description: Swedish year-end closing (bokslut). Use when the user says "bokslut", "arsbokslut", "stang aret", "year-end close", or asks about periodiseringsfond, resultatdisposition, NE-bilaga, or closing the fiscal year.
...
6. Report what remains outside the ledger: NE underlag for enskild firma, and deadlines from the product's data.
